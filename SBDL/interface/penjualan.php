  ...
  <thead>
    ...
    <tbody>
      <?php
          include 'koneksi.php';
          $no = 1; 
          $query = mysqli_query($koneksi, "SELECT penjualan.no_nota, penjualan.tgl_nota, penjualan.harga_jual, penjualan.total, penjualan.jumlah_barang, barang.nama_barang
      ...
      <tr>
          <td scope="col"><?= $no++; ?></td>
          <td scope="col"><?= $data['no_nota'];  ?></td>
          <td scope="col"><?= $data['nama_barang'];  ?></td>
          <td scope="col"><?= $data['tgl_nota'];  ?></td>
          <td scope="col"><?= $data['harga_jual'];  ?></td>
          <td scope="col"><?= $data['jumlah_barang'];  ?></td>
          <td scope="col"><?= $data['total'];  ?></td>
          <td> <a href="hapus_penjualan.php?no_nota=<?= $data['no_nota']?>" type="button" class="btn btn-danger" onclick="return-confirm('Yakin?')">DELETE</a>
      <?php } ?>
        </td>
      </tr>
    </tbody>
